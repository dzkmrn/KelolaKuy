    ...
    <div class="row justify-content-center align-items-center">
        <div class="card" style="width: 24rem;">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ route('tracking.store') }}" id="myForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="status" class="form-control" id="status" value="sedang diproses" aria-describedby="status">
                    </div>
